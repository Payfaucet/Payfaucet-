...
import { createLocalWallet } from "@payfaucet/wallet-evm";
import { createPaymentHandler } from "@payfaucet/payment-evm/exact";
import { wrap as wrapFetch } from "@payfaucet/fetch";
import {
  erc20Abi,
  createPublicClient,
  createWalletClient,
...
import { lookupKnownAsset } from "@payfaucet/info/evm";
...
if (!token) {
  throw new Error("Invalid or Missing Token Address in @payfaucet/info/evm");
}
