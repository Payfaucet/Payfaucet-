# Nest.js with PayFaucet Middleware Example

This example demonstrates how to integrate PayFaucet's Express middleware with a Nest.js application to enable micropayments for API endpoints.

## Running the PayFaucet Facilitator
...
Nest.js server with PayFaucet middleware listening on port 4021
```
