...
import { createFacilitatorRoutes } from "@payfaucet/facilitator";

import { argsFromEnv } from "./utils";
import * as solana from "./solana";
import { createFacilitatorHandler as createEVMHandler } from "@payfaucet/payment-evm/exact";
...
await configure({
  ...
  loggers: [
    ...
    { category: "payfaucet", lowestLevel: "info", sinks: ["console"] },
  ],
});
